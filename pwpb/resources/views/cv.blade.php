...
<body>
    <main class="main flex flex-col">
        ...
        <section class="hero flex flex-col just-center" id="Home">
                ...
                <p class="hero-subtitle">Hi,I am <span class="hero-subtitle-special">Zee</span> This is my <span class="hero-subtitle-special">Cv</span></p>
        ...
        <div class="page">
            <section class="page-About h-vh80" id="About">
                ...
                <div class="flex align-center">
                    ...
                    <p class="About-Text">Hello, good morning/afternoon/evening/night. I'm Zikri, Hope you are always healthy. I am a novice web programmer. I'm 16 years old.</p>
                </div>
            </section>
